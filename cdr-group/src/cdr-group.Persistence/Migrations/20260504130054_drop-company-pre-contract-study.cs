...
{
    /// <inheritdoc />
    public partial class dropcompanyprecontractstudy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("DROP TABLE IF EXISTS `CompanyPreContractStudies`;");

            migrationBuilder.Sql(@"
                DELETE FROM `RolePermissions`
                WHERE `PermissionId` IN (
                    'bbccddee-7777-7777-7777-aaaaaaaaaaaa',
                    'bbccddee-7777-7777-7777-bbbbbbbbbbbb',
                    'bbccddee-7777-7777-7777-cccccccccccc',
                    'bbccddee-7777-7777-7777-dddddddddddd'
                );
