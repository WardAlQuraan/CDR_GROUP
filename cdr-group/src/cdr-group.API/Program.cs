...
builder.Services.AddScoped<ICompanySuccessReasonRepository, CompanySuccessReasonRepository>();
...
builder.Services.AddScoped<ICompanyGeographicExpansionRepository, CompanyGeographicExpansionRepository>();
...
builder.Services.AddScoped<ICompanySuccessReasonService, CompanySuccessReasonService>();
...
builder.Services.AddScoped<ICompanyGeographicExpansionService, CompanyGeographicExpansionService>();
