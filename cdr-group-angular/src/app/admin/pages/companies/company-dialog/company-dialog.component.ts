  ...
  private initForm(): void {
    if (this.isEditMode) {
      ...
      this.form = this.fb.group({
        ...
        descriptionEn: [company.descriptionEn, [Validators.maxLength(2000)]],
        descriptionAr: [company.descriptionAr, [Validators.maxLength(2000)]],
        storyEn: [company.storyEn, [Validators.maxLength(2000)]],
        storyAr: [company.storyAr, [Validators.maxLength(2000)]],
        missionEn: [company.missionEn, [Validators.maxLength(1000)]],
        missionAr: [company.missionAr, [Validators.maxLength(1000)]],
        visionEn: [company.visionEn, [Validators.maxLength(1000)]],
        visionAr: [company.visionAr, [Validators.maxLength(1000)]],
      ...
      this.form = this.fb.group({
        ...
        storyEn: ['', [Validators.maxLength(2000)]],
        storyAr: ['', [Validators.maxLength(2000)]],
        missionEn: ['', [Validators.maxLength(1000)]],
        missionAr: ['', [Validators.maxLength(1000)]],
        visionEn: ['', [Validators.maxLength(1000)]],
        visionAr: ['', [Validators.maxLength(1000)]],
