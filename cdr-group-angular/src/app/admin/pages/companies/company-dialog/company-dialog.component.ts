  ...
  private initForm(): void {
    if (this.isEditMode) {
      ...
      this.form = this.fb.group({
        nameEn: [company.nameEn, [Validators.required, Validators.minLength(2), Validators.maxLength(200)]],
        nameAr: [company.nameAr, [Validators.required, Validators.minLength(2), Validators.maxLength(200)]],
        descriptionEn: [company.descriptionEn, [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        descriptionAr: [company.descriptionAr, [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        storyEn: [company.storyEn, [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        storyAr: [company.storyAr, [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        missionEn: [company.missionEn, [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        missionAr: [company.missionAr, [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        visionEn: [company.visionEn, [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        visionAr: [company.visionAr, [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        titleEn: [company.titleEn, [Validators.required, Validators.minLength(2), Validators.maxLength(500)]],
        titleAr: [company.titleAr, [Validators.required, Validators.minLength(2), Validators.maxLength(500)]],
      ...
      this.form = this.fb.group({
        ...
        descriptionEn: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        descriptionAr: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        storyEn: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        storyAr: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]],
        missionEn: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        missionAr: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        visionEn: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        visionAr: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(1000)]],
        titleEn: ['', [Validators.required, Validators.minLength(2), Validators.maxLength(500)]],
        titleAr: ['', [Validators.required, Validators.minLength(2), Validators.maxLength(500)]],
