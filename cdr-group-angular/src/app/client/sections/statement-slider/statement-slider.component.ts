...
@Component({
  selector: 'app-statement-slider',
  standalone: false,
  templateUrl: './statement-slider.component.html',
  styleUrl: './statement-slider.component.scss',
})
export class StatementSliderComponent implements OnChanges, OnDestroy {
  @Input() companyId = '';
  @Input() code = '';
  @Input() titleCode = '';
  ...
  private startAutoplay(): void {
    ...
    }, StatementSliderComponent.AUTOPLAY_MS);
  }
